...
export const metadata: Metadata = {
  title: "Creative Marketing Agency | Brand Strategy & Digital Marketing",
  description: "Transform your brand with strategic creative excellence. We deliver bold campaigns that drive growth. Expert team in digital marketing and brand transformation.",
  keywords: "marketing agency, creative services, brand strategy, digital marketing, campaign development, creative advertising",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "CreativeStudio - Transform Your Brand",
    description: "Strategic creative excellence for ambitious brands. Bold campaigns that drive measurable results.",
    type: "website",
    siteName: "CreativeStudio",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SzEkxKoNyIbQ4hnQYui6BHsfB/uploaded-1765834160306-0bi8ox02.jpg",
      alt: "Creative team transforming brands"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Creative Marketing Agency | CreativeStudio",
    description: "Transform your brand with strategic campaigns that drive growth",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SzEkxKoNyIbQ4hnQYui6BHsfB/uploaded-1765834160306-0bi8ox02.jpg"]
  }
};
